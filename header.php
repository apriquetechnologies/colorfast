...
<header class="header">
    ...
    <div class="container">
        ...
        <a href="<?php echo $lumise->cfg->url; ?>" class="logo">
            ...
            <img src="https://www.colorfast.in/assets/images/logo.png" alt="ColorFast | Delivering Unique Printing Solutions">
        ...
        <div class="menu">
            ...
            <ul class="main-menu">
				...
				<?php if(!$lumise->connector->get_session('user_id')){ ?>
					<li><a href="<?php echo $lumise->cfg->url.'signin.php'; ?>">SignIn</a></li>
					<li><a href="<?php echo $lumise->cfg->url.'register.php'; ?>">Register</a></li>
				<?php }else{ ?>
	                <li><a href="<?php echo $lumise->cfg->url.'orders.php'; ?>">My Orders</a></li>
	                <li><a href="<?php echo $lumise->cfg->url.'signin.php?logout=true'; ?>">Logout <?= $lumise->connector->get_session('user_first_name'); ?></a></li>
				<?php } ?>

                <li><a href="<?php echo $lumise->cfg->url.'contactus.php'; ?>">Contact Us</a></li>
        ...
        <div class="menu_mobile">
            ...
            <a href="<?php echo $lumise->cfg->url; ?>" class="logo_mobile"><img src="https://www.colorfast.in/assets/images/logo.png" alt=""></a>
